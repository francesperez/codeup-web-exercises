...
let arrayk = [3,4,5,6,7,85,3,2,4];
//REMOVE EVERY ODD NUMBER FROM THE ARRAY ABOVE
...
//--Write a function that takes an array of numericvalues and returns an array with all those values doubled
...
function cityAndStateObject(cityAndState){
    return {
